...
Timeline.attributes.add('yoyo', { type : 'number', default : 4 });
...
Timeline.attributes.add('step', { type : 'number' , default : 1});
...
Timeline.prototype.onPlay = function() {
    ...
    if(this.position){
        ...
        this.positionFrames.on('complete', function () {
            if(this.entity.script.timeOne !== undefined){
                this.entity.script.timeOne.setStarted(true);
                this.entity.script.timeOne.fire();
            }
        });
